...
- =grep --invert-match --file=exclude.txt= ::
  ...
  The exclude file is a list of words that are ignored when producing the report, and currently consists of the =HEAD= HTTP request type and the path to the feed file:
  ...
  #+RESULTS[06d24bb9e706ce946670603642b93a256cc28b44]:
  : feed.xml
